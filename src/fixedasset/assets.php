...
// [FIX] Do not include template/header.php here.
// header.php outputs HTML, so it must be loaded only after all header("Location: ...") redirects are finished.
...
// [FIX] Include visual header after all redirect logic is complete.
// This prevents: Cannot modify header information - headers already sent.
...
<?php endforeach; ?>		
    ...
    <?php endif; ?>	
	<div class="mb-2"><a href="assets_export.php" class="btn btn-outline-success">Export Excel</a></div>

    <!-- Filter -->
    <form class="row g-2 mb-3">
        <div class="col-md-3">
            <!-- [FIX] PHP 8 / Docker migration: protect search value from NULL before htmlspecialchars(). -->
    ...
    <table class="table table-bordered table-sm">
        <thead class="table-light">
            <tr>
                <th>#</th><th>Code</th><th>Name</th><th>Department</th><th>Location</th><th>Serial no</th><th>Model</th><th>Type</th><th>Comp name</th><th>Start date</th><th>Expire date</th><th>Status</th><th>Note</th><th width="130">Action</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <!-- [FIX] PHP 8 / Docker migration:
                     Legacy rows may contain NULL values. htmlspecialchars(NULL) shows deprecated warnings,
                     so every printable field gets an empty string fallback. -->
